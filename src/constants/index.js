...
export const experiences =[
  {
    ...
    job: "Java & Frontend Fundamentals",
    date: "2023",
    contents: [
      "Began exploring web development through Java and frontend fundamentals including HTML, CSS, and JavaScript.",
      "Built basic static sites to practice layout, design principles, and DOM manipulation.",
      "Started learning programming logic and problem-solving using Java.",
    ],
  },
  {
    title: "Full-Stack Developer (Learner)",
    job: "Self-Directed Projects",
    date: "2024",
    contents: [
      "Learned full-stack web development using the MERN stack (MongoDB, Express.js, React, Node.js).",
      "Built basic full-stack apps with user authentication, REST APIs, and database operations.",
      "Explored deployment, version control with Git/GitHub, and responsive UI design.",
      "Completed several personal projects to reinforce concepts and solidify skills.",
    ],
  },
  {
    ...
    date: "2025–Present",
    contents: [
      "Building advanced full-stack projects such as AI-assisted coding platforms and Uber-style apps using MERN and AI APIs.",
      "Created a dynamic portfolio using Three.js, React, Vite, and WebAPI to showcase projects and skills.",
      "Actively learning advanced concepts in cybersecurity, AI integration, and system design.",
      "Planning to explore internships or freelance roles in 2025 to transition into the industry.",
    ],
  },
];
