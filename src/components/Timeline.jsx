...
export const Timeline = ({
  ...
  return (
    <div
      ...
      ref={containerRef}>
        <h2 className="text-heading ">My World Experience</h2>
          ...
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div className="flex-col hidden gap-2 text-xl font-bold md:flex md:pl-20 md:text-4xl text-neutral-300 ">
                ...
                <h3 className="text-3xl text-netural-500"s>{item.job}</h3>
              </div>
            </div>

            <div className="relative pl-20 pr-4 md:pl-4 w-full">
          <div className="block md:hidden mb-4 text-2xl font-bold text-left text-netural-300">
             <h3>{item.date}</h3>
            <h3>{item.job}</h3>
          </div>
