...
import CopyEmailBotton from "../components/CopyEmailBotton.jsx";
import { Frameworks } from '../components/framWorks.jsx';
    ...
    <section className='c-space section-spacing'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
            ...
            <div className='flex items-end grid-default-color grid-1'>
                ...
                />
                <div className='z-10'>
                    <p className='headtext'>Hi, I'm Shashwat </p>
                    <p className='subtext'>
                        Over the past few Year, I developed my frontend and Backend dev
                        skills to deliver dynamic and software  and web application. 
                    </p>
                </div>
                <div className='absolute inest-x-0 pointer-events-none -bottom-4 h-1/2 sm:h-1/3 bg-gradient-to-t from-indigo'/>  
            </div>
            {/* Grid 2 */}
            ...
            <div className='grid-default-color grid-5'>
                <div className='z-10 w-[50%]'>
                    ...
                    <p className='subText'>
                        I specialize in a variety of lanuages, frameWorks, and tools that help me build robust and scalable applications.
                    </p>
                </div>
